                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('chapter.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-gourp">
                            ...
                            <input type="text" class="form-control" value="{{old('tomtat')}}" name="tomtat"  aria-describedby="emailHelp"  placeholder="Tóm tắt chapter...">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nội dung</label>
                            <textarea name="noidung" id="noidung_chapter" cols="30" rows="5" style="resize: none;" class="form-control" ></textarea>
                        </div>
                        <div class="form-group">
