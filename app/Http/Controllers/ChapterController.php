...
class ChapterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            'tieude.required' => 'Vui lòng điền tiêu đề cho chapter',
            'tieude.unique' => 'Tiêu đề chapter đã tồn tại, xin điền tiêu đề khác',
            'slug_chapter.required' => 'Slug chapter chưa có',
            'slug_chapter.unique' => 'Slug chapter đã có, xin điền tên khác',
            'tomtat.required' => 'Vui lòng điền tóm tắt chapter cho truyện',
            'noidung.required' => 'Vui lòng điền nội dung cho chapter',
        ]
        );
